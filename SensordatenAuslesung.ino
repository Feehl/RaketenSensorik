...
void loop() {
  ...
  // Ausgabe des in den Anführungzeichen zu sehenden Textes und der dazugehörigen Sensorwerte auf dem seriellen Monitor
  ...
  // Anweisung zum fünfhundertmillisekündigen warten des Programs vor dem weiteren ablaufen
  delay(500);
}
